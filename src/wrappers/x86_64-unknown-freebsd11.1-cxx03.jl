# Autogenerated wrapper script for libLLVM_jll for x86_64-unknown-freebsd11.1-cxx03
...
function __init__()
    ...
    foreach(p -> append!(PATH_list, p), (LLVM_full_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (LLVM_full_jll.LIBPATH_list,))
