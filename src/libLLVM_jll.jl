...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libLLVM_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("8f36deef-c2a5-5394-99ed-8e07531fb29a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libLLVM", artifacts_toml) for e in artifacts["libLLVM"]]
...
if best_platform === nothing
    @debug("Unable to load libLLVM; unsupported platform $(triplet(platform_key_abi()))")
else
